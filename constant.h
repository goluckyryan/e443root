...
//const double STACK_TOF_OFFSET[6] = {168.93+2.5, 167.45+2.5, 161.49+2.5, 159.36+2.5, 160.86+2.5, 159.12+2.5}; //ns #1035
const double STACK_TOF_OFFSET[6] = {168.93+2.5-0.25, 167.45+2.5-0.33, 161.49+2.5-0.33, 159.36+2.5-0.49, 160.86+2.5-0.50, 159.12+2.5-0.25}; //ns #1034
...
const double Td = 195.; //MeV /energy of deuteron beam
