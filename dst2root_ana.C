...
int main(int argc, char * argv[]){
  ...
  Double_t ran_adc[12];//ran_adc=adc+random(0,1)
  ...
  t1->Branch("ran_adc", ran_adc, "ran_adc[12]/D");
  ...
  do{
   ...
   //============================================= read from file
    ...
    if (!TMath::IsNaN(tdc[2]) && tdc[2]<1350 && !TMath::IsNaN(tdc[3])) sta2hTri = 1;
    ...
    ran_adc[0] = adc[0] + rand->Uniform(0,1);
    ran_adc[1] = adc[1] + rand->Uniform(0,1);
    ran_adc[2] = adc[2] + rand->Uniform(0,1);
    ran_adc[3] = adc[3] + rand->Uniform(0,1);
    ran_adc[4] = adc[4] + rand->Uniform(0,1);
    ran_adc[5] = adc[5] + rand->Uniform(0,1);
    ran_adc[6] = adc[6] + rand->Uniform(0,1);
    ran_adc[7] = adc[7] + rand->Uniform(0,1);
    ran_adc[8] = adc[8] + rand->Uniform(0,1);
    ran_adc[9] = adc[9] + rand->Uniform(0,1);
    ran_adc[10] = adc[10] + rand->Uniform(0,1);
    ran_adc[11] = adc[11] + rand->Uniform(0,1);
    /*  
      if (ran_adc[0]>=0 && ran_adc[1]>=0){ 
      sta1h = 6.4 * TMath::Sqrt(ran_adc[0]/112.*ran_adc[1]/118.)/0.8130;
    }else if (ran_adc[0]<0 && ran_adc[1]<0){
      sta1h = -6.4 * TMath::Sqrt(ran_adc[0]/112.*ran_adc[1]/118.)/0.8130;
    }else if (ran_adc[0]*ran_adc[1]<=0){
      sta1h = 6.4 * TMath::Sqrt(-ran_adc[0]/112.*ran_adc[1]/118.)/0.8130*(2*(rand->Integer(2))-1.);
      }

    if (ran_adc[2]>0 && ran_adc[3]>0){ 
      sta2h = 6.4 * TMath::Sqrt(ran_adc[2]/131.*ran_adc[3]/109.)/0.8748 ;
    }else if (ran_adc[2]<0 && ran_adc[3]<0){
      sta2h = -6.4 * TMath::Sqrt(ran_adc[2]/131.*ran_adc[3]/109.)/0.8748 ;
    }else{
      sta2h = 6.4 * TMath::Sqrt(-ran_adc[2]/131.*ran_adc[3]/109.)/0.8748;if ( (ran_adc[2]/131.+ran_adc[3]/109.) < 0) sta2h=-sta2h;
    }

    if (ran_adc[4]>0 && ran_adc[5]>0){ 
      sta1v = 6.4 * TMath::Sqrt(ran_adc[4]/116.*ran_adc[5]/126.)/0.8267;
    }else if (ran_adc[4]<0 && ran_adc[5]<0){
      sta1v = -6.4 * TMath::Sqrt(ran_adc[4]/116.*ran_adc[5]/126.)/0.8267;
    }else{
      sta1v = 6.4 * TMath::Sqrt(-ran_adc[4]/116.*ran_adc[5]/126.)/0.8267;if ( (ran_adc[4]/116.+ran_adc[5]/126.) < 0) sta1v=-sta1v;
    }

    if (ran_adc[6]>0 && ran_adc[7]>0){ 
      sta2v = 6.4 * TMath::Sqrt(ran_adc[6]/113.*ran_adc[7]/123.)/0.7382;
    }else if (ran_adc[6]<0 && ran_adc[7]<0){
      sta2v = -6.4 * TMath::Sqrt(ran_adc[6]/113.*ran_adc[7]/123.)/0.7382;
    }else{
      sta2v = 6.4 * TMath::Sqrt(-ran_adc[6]/113.*ran_adc[7]/123.)/0.7382;if ( (ran_adc[6]/113.+ran_adc[7]/123.) < 0) sta2v=-sta2v;
    }

    //if (0 < tdc[8] && tdc[8] < 400 && 0 < tdc[9] && tdc[9] < 400){ // offset #1223 proton case
    //sta3v = (6.4 * TMath::Sqrt(ran_adc[8]/122.*ran_adc[9]/131.)+3.0341)/0.7383;
    //}else 
    if (ran_adc[8]>0 && ran_adc[9]>0){ 
      sta3v = 6.4 * TMath::Sqrt(ran_adc[8]/122.*ran_adc[9]/131.)/0.7383;
    }else if (ran_adc[8]<0 && ran_adc[9]<0){
      sta3v = -6.4 * TMath::Sqrt(ran_adc[8]/122.*ran_adc[9]/131.)/0.7383;
    }else{
      sta3v = 6.4 * TMath::Sqrt(-ran_adc[8]/122.*ran_adc[9]/131.)/0.7383;if ( (ran_adc[8]/122.+ran_adc[9]/131.) < 0) sta3v=-sta3v;
    }
    
    //if (0 < tdc[10] && tdc[10] < 400 && 0 < tdc[11] && tdc[11] < 400){ // offset #1223 proton case
    //sta4v = (6.4 * TMath::Sqrt(ran_adc[10]/127.*ran_adc[11]/124.)+2.5245)/0.7538;
    //}else 
    if (ran_adc[10]>0 && ran_adc[11]>0){ 
      sta4v = 6.4 * TMath::Sqrt(ran_adc[10]/127.*ran_adc[11]/124.)/0.7538;
    }else if (ran_adc[10]<0 && ran_adc[11]<0){
      sta4v = -6.4 * TMath::Sqrt(ran_adc[10]/127.*ran_adc[11]/124.)/0.7538;
    }else{
      sta4v = 6.4 * TMath::Sqrt(-ran_adc[10]/127.*ran_adc[11]/124.)/0.7538;if ( (ran_adc[10]/127.+ran_adc[11]/124.) < 0) sta4v=-sta4v;
      }
    */
    sta1h = 6.4 * (TMath::Sqrt((ran_adc[0]+20)*(ran_adc[1]+20))-20)/sqrt(112.*118.)/0.8130;
    sta2h = 6.4 * (TMath::Sqrt((ran_adc[2]+20)*(ran_adc[3]+20))-20)/sqrt(131.*109.)/0.8748;
    sta1v = 6.4 * (TMath::Sqrt((ran_adc[4]+20)*(ran_adc[5]+20))-20)/sqrt(116.*126.)/0.8267;
    sta2v = 6.4 * (TMath::Sqrt((ran_adc[6]+20)*(ran_adc[7]+20))-20)/sqrt(113.*123.)/0.7382;
    //if (0 < tdc[8] && tdc[8] < 400 && 0 < tdc[9] && tdc[9] < 400){ // offset #1223 proton case
    // sta3v = (6.4 * (TMath::Sqrt((ran_adc[8]+20)*(ran_adc[9]+20))-20)/sqrt(122.*131.)+3.0341)/0.7383;
    //}else 
    sta3v = 6.4 * (TMath::Sqrt((ran_adc[8]+20)*(ran_adc[9]+20))-20)/sqrt(122.*131.)/0.7383;
    //if (0 < tdc[10] && tdc[10] < 400 && 0 < tdc[11] && tdc[11] < 400){ // offset #1223 proton case
    // sta4v = (6.4 * (TMath::Sqrt((ran_adc[10]+20)*(ran_adc[11]+20))-20)/sqrt(127.*124.)+2.5245)/0.7538;
    //}else 
    sta4v = 6.4 * (TMath::Sqrt((ran_adc[10]+20)*(ran_adc[11]+20))-20)/sqrt(127.*124.)/0.7538;
    ...
    */
    /*
    if ((sta1hTri==1 && sta2hTri==0 && sta2vTri==0 && sta3vTri==0 && sta4vTri==0) || sta1vTri==1){
      sta_even = sta1h/1.12;
      sta_odd = sta1v;
    }
    if ((sta1hTri==1 && sta2hTri==0 && sta1vTri==0 && sta3vTri==0 && sta4vTri==0) || sta2vTri==1){
      sta_even = sta1h/1.12;
      sta_odd = sta2v/1.14;
    }
    if ((sta1hTri==1 && sta2hTri==0 && sta1vTri==0 && sta2vTri==0 && sta4vTri==0) || sta3vTri==1){
      sta_even = sta1h/1.12;
      sta_odd = sta3v/1.14;
    }
    if ((sta1hTri==1 && sta2hTri==0 && sta1vTri==0 && sta2vTri==0 && sta3vTri==0) || sta4vTri==1){
      sta_even = sta1h/1.12;
      sta_odd = sta4v/1.1;
    }
    if ((sta2hTri==1 && sta1hTri==0 && sta2vTri==0 && sta3vTri==0 && sta4vTri==0) || sta1vTri==1){
      sta_even = sta2h*1.03;
      sta_odd = sta1v;
    }
    if ((sta2hTri==1 && sta1hTri==0 && sta1vTri==0 && sta3vTri==0 && sta4vTri==0) || sta2vTri==1){
      sta_even = sta2h*1.03;
      sta_odd = sta2v/1.14;
    }
    if ((sta2hTri==1 && sta1hTri==0 && sta1vTri==0 && sta2vTri==0 && sta4vTri==0) || sta3vTri==1){
      sta_even = sta2h*1.03;
      sta_odd = sta3v/1.14;
    }
    if ((sta2hTri==1 && sta1hTri==0 && sta1vTri==0 && sta2vTri==0 && sta3vTri==0) || sta4vTri==1){
      sta_even = sta2h*1.03;
      sta_odd = sta4v/1.1;
    }
    ...
    */
     //Mh=1,Mv=0
    if (sta1hTri==1 && sta2hTri==0 && sta1vTri==0 && sta2vTri==0 && sta3vTri==0 && sta4vTri==0){
      sta_even = sta1h;
      //if (sta1hTdif+2.5<=-2.) sta_odd = sta1v;
      //else if (sta1hTdif+2.5>-2.&&sta1hTdif+2.5<=0.) sta_odd = sta2v;
      //else if (sta1hTdif+2.5>0.&&sta1hTdif+2.5<=2.) sta_odd = sta3v;
      //else sta_odd = sta4v;
      if (sta1v>sta2v && sta1v>sta3v && sta1v>sta4v) sta_odd = sta1v;
      else if (sta2v>sta1v && sta2v>sta3v && sta2v>sta4v) sta_odd = sta2v;
      else if (sta3v>sta1v && sta3v>sta2v && sta3v>sta4v) sta_odd = sta3v;
      else if (sta4v>sta1v && sta4v>sta2v && sta4v>sta3v) sta_odd = sta4v;
    }
    if (sta1hTri==0 && sta2hTri==1 && sta1vTri==0 && sta2vTri==0 && sta3vTri==0 && sta4vTri==0){
      sta_even = sta2h;
      //if (sta2hTdif+11.8<=-2.) sta_odd = sta1v;
      //else if (sta2hTdif+11.8>-2.&&sta2hTdif+11.8<=0.) sta_odd = sta2v;
      //else if (sta2hTdif+11.8>0.&&sta2hTdif+11.8<=2.) sta_odd = sta3v;
      //else sta_odd = sta4v;
      if (sta1v>sta2v && sta1v>sta3v && sta1v>sta4v) sta_odd = sta1v;
      else if (sta2v>sta1v && sta2v>sta3v && sta2v>sta4v) sta_odd = sta2v;
      else if (sta3v>sta1v && sta3v>sta2v && sta3v>sta4v) sta_odd = sta3v;
    ...
    //Mh=0,Mv=1
    if (sta1hTri==0 && sta2hTri==0 && sta1vTri==1 && sta2vTri==0 && sta3vTri==0 && sta4vTri==0){
      sta_odd = sta1v;
      //if (sta1vTdif<=-10.4) sta_even = sta1h;
      //else sta_even = sta2h;
      if (sta1h>=sta2h) sta_even = sta1h;
      else sta_even = sta2h;
    }
    if (sta1hTri==0 && sta2hTri==0 && sta1vTri==0 && sta2vTri==1 && sta3vTri==0 && sta4vTri==0){
      sta_odd = sta2v;
      //if (sta2vTdif<=-12.0) sta_even = sta1h;
      //else sta_even = sta2h;
      if (sta1h>=sta2h) sta_even = sta1h;
      else sta_even = sta2h;
    }
    if (sta1hTri==0 && sta2hTri==0 && sta1vTri==0 && sta2vTri==0 && sta3vTri==1 && sta4vTri==0){
      sta_odd = sta3v;
      //if (sta3vTdif<=-14.5) sta_even = sta1h;
      //else sta_even = sta2h;
      if (sta1h>=sta2h) sta_even = sta1h;
      else sta_even = sta2h;
    }
    if (sta1hTri==0 && sta2hTri==0 && sta1vTri==0 && sta2vTri==0 && sta3vTri==0 && sta4vTri==1){
      sta_odd = sta4v;
      //if (sta4vTdif<=-8.7) sta_even = sta1h;
      //else sta_even = sta2h;
      if (sta1h>=sta2h) sta_even = sta1h;
      else sta_even = sta2h;
    }
    //Mh=2,Mv=0
    if (sta1hTri==1 && sta2hTri==1 && sta1vTri==0 && sta2vTri==0 && sta3vTri==0 && sta4vTri==0){
      sta_even = sta1h+sta2h;
      if (sta1v>sta2v && sta1v>sta3v && sta1v>sta4v) sta_odd = sta1v;
      else if (sta2v>sta1v && sta2v>sta3v && sta2v>sta4v) sta_odd = sta2v;
      else if (sta3v>sta1v && sta3v>sta2v && sta3v>sta4v) sta_odd = sta3v;
    ...
    //Mh=0, Mv=2,3,4
    if (sta1hTri==0 && sta2hTri==0 && sta1vTri==1 && sta2vTri==1 && sta3vTri==0 && sta4vTri==0){
      sta_odd = sta1v+sta2v;
      if (sta1h>=sta2h) sta_even = sta1h;
      else sta_even = sta2h;
    }
    if (sta1hTri==0 && sta2hTri==0 && sta1vTri==1 && sta2vTri==0 && sta3vTri==1 && sta4vTri==0){
      sta_odd = sta1v+sta3v;
      if (sta1h>=sta2h) sta_even = sta1h;
      else sta_even = sta2h;
    }
    if (sta1hTri==0 && sta2hTri==0 && sta1vTri==1 && sta2vTri==0 && sta3vTri==0 && sta4vTri==1){
      sta_odd = sta1v+sta4v;
      if (sta1h>=sta2h) sta_even = sta1h;
      else sta_even = sta2h;
    }
    if (sta1hTri==0 && sta2hTri==0 && sta1vTri==0 && sta2vTri==1 && sta3vTri==1 && sta4vTri==0){
      sta_odd = sta2v+sta3v;
      if (sta1h>=sta2h) sta_even = sta1h;
      else sta_even = sta2h;
    }
    if (sta1hTri==0 && sta2hTri==0 && sta1vTri==0 && sta2vTri==1 && sta3vTri==0 && sta4vTri==1){
      sta_odd = sta2v+sta4v;
      if (sta1h>=sta2h) sta_even = sta1h;
      else sta_even = sta2h;
    }
    if (sta1hTri==0 && sta2hTri==0 && sta1vTri==0 && sta2vTri==0 && sta3vTri==1 && sta4vTri==1){
      sta_odd = sta3v+sta4v;
      if (sta1h>=sta2h) sta_even = sta1h;
      else sta_even = sta2h;
    }
    if (sta1hTri==0 && sta2hTri==0 && sta1vTri==1 && sta2vTri==1 && sta3vTri==1 && sta4vTri==0){
      sta_odd = sta1v+sta2v+sta3v;
      if (sta1h>=sta2h) sta_even = sta1h;
      else sta_even = sta2h;
    }
    if (sta1hTri==0 && sta2hTri==0 && sta1vTri==1 && sta2vTri==1 && sta3vTri==0 && sta4vTri==1){
      sta_odd = sta1v+sta2v+sta4v;
      if (sta1h>=sta2h) sta_even = sta1h;
      else sta_even = sta2h;
    }
    if (sta1hTri==0 && sta2hTri==0 && sta1vTri==1 && sta2vTri==0 && sta3vTri==1 && sta4vTri==1){
      sta_odd = sta1v+sta3v+sta4v;
      if (sta1h>=sta2h) sta_even = sta1h;
      else sta_even = sta2h;
    }
    if (sta1hTri==0 && sta2hTri==0 && sta1vTri==0 && sta2vTri==1 && sta3vTri==1 && sta4vTri==1){
      sta_odd = sta2v+sta3v+sta4v;
      if (sta1h>=sta2h) sta_even = sta1h;
      else sta_even = sta2h;
    }
    if (sta1hTri==0 && sta2hTri==0 && sta1vTri==1 && sta2vTri==1 && sta3vTri==1 && sta4vTri==1){
      sta_odd = sta1v+sta2v+sta3v+sta4v;
      if (sta1h>=sta2h) sta_even = sta1h;
      else sta_even = sta2h;
    }
    //Mh=1,Mv=1
    if (sta1hTri==1 && sta2hTri==0 && sta1vTri==1 && sta2vTri==0 && sta3vTri==0 && sta4vTri==0){
      sta_even = sta1h;
      sta_odd = sta1v;
    }
    if (sta1hTri==1 && sta2hTri==0 && sta1vTri==0 && sta2vTri==1 && sta3vTri==0 && sta4vTri==0){
      sta_even = sta1h;
      sta_odd = sta2v;
    }
    if (sta1hTri==1 && sta2hTri==0 && sta1vTri==0 && sta2vTri==0 && sta3vTri==1 && sta4vTri==0){
      sta_even = sta1h;
      sta_odd = sta3v;
    }
    if (sta1hTri==1 && sta2hTri==0 && sta1vTri==0 && sta2vTri==0 && sta3vTri==0 && sta4vTri==1){
    ...
    if (sta1hTri==0 && sta2hTri==1 && sta1vTri==1 && sta2vTri==0 && sta3vTri==0 && sta4vTri==0){
      sta_even = sta2h;
      sta_odd = sta1v;
    }
    if (sta1hTri==0 && sta2hTri==1 && sta1vTri==0 && sta2vTri==1 && sta3vTri==0 && sta4vTri==0){
      sta_even = sta2h;
      sta_odd = sta2v;
    }
    if (sta1hTri==0 && sta2hTri==1 && sta1vTri==0 && sta2vTri==0 && sta3vTri==1 && sta4vTri==0){
      sta_even = sta2h;
      sta_odd = sta3v;
    }
    if (sta1hTri==0 && sta2hTri==1 && sta1vTri==0 && sta2vTri==0 && sta3vTri==0 && sta4vTri==1){
      sta_even = sta2h;
      sta_odd = sta4v;
    }
    //Mh=2,Mv=1
    if (sta1hTri==1 && sta2hTri==1 && sta1vTri==1 && sta2vTri==0 && sta3vTri==0 && sta4vTri==0){
      sta_even = sta1h + sta2h;
      sta_odd = sta1v;
    }
    if (sta1hTri==1 && sta2hTri==1 && sta1vTri==0 && sta2vTri==1 && sta3vTri==0 && sta4vTri==0){
      sta_even = sta1h + sta2h;
      sta_odd = sta2v;
    }
    if (sta1hTri==1 && sta2hTri==1 && sta1vTri==0 && sta2vTri==0 && sta3vTri==1 && sta4vTri==0){
      sta_even = sta1h + sta2h;
      sta_odd = sta3v;
    }
    if (sta1hTri==1 && sta2hTri==1 && sta1vTri==0 && sta2vTri==0 && sta3vTri==0 && sta4vTri==1){
      sta_even = sta1h + sta2h;
      sta_odd = sta4v;
    }
    //1h=1,Mv=2,3,4
    if (sta1hTri==1 && sta2hTri==0 && sta1vTri==1 && sta2vTri==1 && sta3vTri==0 && sta4vTri==0){
      sta_even = sta1h;
      sta_odd = sta1v + sta2v;
    }
    if (sta1hTri==1 && sta2hTri==0 && sta1vTri==1 && sta2vTri==0 && sta3vTri==1 && sta4vTri==0){
      sta_even = sta1h;
      sta_odd = sta1v + sta3v;
    }
    if (sta1hTri==1 && sta2hTri==0 && sta1vTri==1 && sta2vTri==0 && sta3vTri==0 && sta4vTri==1){
      sta_even = sta1h;
      sta_odd = sta1v + sta4v;
    }
    if (sta1hTri==1 && sta2hTri==0 && sta1vTri==0 && sta2vTri==1 && sta3vTri==1 && sta4vTri==0){
      sta_even = sta1h;
      sta_odd = sta2v + sta3v;
    }
    if (sta1hTri==1 && sta2hTri==0 && sta1vTri==0 && sta2vTri==1 && sta3vTri==0 && sta4vTri==1){
      sta_even = sta1h;
      sta_odd = sta2v + sta4v;
    }
    if (sta1hTri==1 && sta2hTri==0 && sta1vTri==0 && sta2vTri==0 && sta3vTri==1 && sta4vTri==1){
      sta_even = sta1h;
      sta_odd = sta3v + sta4v;
    }
    if (sta1hTri==1 && sta2hTri==0 && sta1vTri==1 && sta2vTri==1 && sta3vTri==1 && sta4vTri==0){
      sta_even = sta1h;
      sta_odd = sta1v + sta2v + sta3v;
    }
    if (sta1hTri==1 && sta2hTri==0 && sta1vTri==1 && sta2vTri==1 && sta3vTri==0 && sta4vTri==1){
      sta_even = sta1h;
      sta_odd = sta1v + sta2v + sta4v;
    }
    if (sta1hTri==1 && sta2hTri==0 && sta1vTri==1 && sta2vTri==0 && sta3vTri==1 && sta4vTri==1){
      sta_even = sta1h;
      sta_odd = sta1v + sta3v + sta4v;
    }
    if (sta1hTri==1 && sta2hTri==0 && sta1vTri==0 && sta2vTri==1 && sta3vTri==1 && sta4vTri==1){
      sta_even = sta1h;
      sta_odd = sta2v + sta3v + sta4v;
    }
    if (sta1hTri==1 && sta2hTri==0 && sta1vTri==1 && sta2vTri==1 && sta3vTri==1 && sta4vTri==1){
      sta_even = sta1h;
      sta_odd = sta1v + sta2v + sta3v + sta4v;
    }
    //2h=1,Mv=2,3,4
    if (sta1hTri==0 && sta2hTri==1 && sta1vTri==1 && sta2vTri==1 && sta3vTri==0 && sta4vTri==0){
      sta_even = sta2h;
      sta_odd = sta1v + sta2v;
    }
    if (sta1hTri==0 && sta2hTri==1 && sta1vTri==1 && sta2vTri==0 && sta3vTri==1 && sta4vTri==0){
      sta_even = sta2h;
      sta_odd = sta1v + sta3v;
    }
    if (sta1hTri==0 && sta2hTri==1 && sta1vTri==1 && sta2vTri==0 && sta3vTri==0 && sta4vTri==1){
      sta_even = sta2h;
      sta_odd = sta1v + sta4v;
    }
    if (sta1hTri==0 && sta2hTri==1 && sta1vTri==0 && sta2vTri==1 && sta3vTri==1 && sta4vTri==0){
      sta_even = sta2h;
      sta_odd = sta2v + sta3v;
    }
    if (sta1hTri==0 && sta2hTri==1 && sta1vTri==0 && sta2vTri==1 && sta3vTri==0 && sta4vTri==1){
      sta_even = sta2h;
      sta_odd = sta2v + sta4v;
    }
    if (sta1hTri==0 && sta2hTri==1 && sta1vTri==0 && sta2vTri==0 && sta3vTri==1 && sta4vTri==1){
      sta_even = sta2h;
      sta_odd = sta3v + sta4v;
    }
    if (sta1hTri==0 && sta2hTri==1 && sta1vTri==1 && sta2vTri==1 && sta3vTri==1 && sta4vTri==0){
      sta_even = sta2h;
      sta_odd = sta1v + sta2v + sta3v;
    }
    if (sta1hTri==0 && sta2hTri==1 && sta1vTri==1 && sta2vTri==1 && sta3vTri==0 && sta4vTri==1){
      sta_even = sta2h;
      sta_odd = sta1v + sta2v + sta4v;
    }
    if (sta1hTri==0 && sta2hTri==1 && sta1vTri==1 && sta2vTri==0 && sta3vTri==1 && sta4vTri==1){
      sta_even = sta2h;
      sta_odd = sta1v + sta3v + sta4v;
    }
    if (sta1hTri==0 && sta2hTri==1 && sta1vTri==0 && sta2vTri==1 && sta3vTri==1 && sta4vTri==1){
      sta_even = sta2h;
      sta_odd = sta2v + sta3v + sta4v;
    }
    if (sta1hTri==0 && sta2hTri==1 && sta1vTri==1 && sta2vTri==1 && sta3vTri==1 && sta4vTri==1){
      sta_even = sta2h;
      sta_odd = sta1v + sta2v + sta3v + sta4v;
    }
    //Mh=2,Mv=2,3,4
    if (sta1hTri==1 && sta2hTri==1 && sta1vTri==1 && sta2vTri==1 && sta3vTri==0 && sta4vTri==0){
      sta_even = sta1h + sta2h;
      sta_odd = sta1v + sta2v;
    }
    if (sta1hTri==1 && sta2hTri==1 && sta1vTri==1 && sta2vTri==0 && sta3vTri==1 && sta4vTri==0){
      sta_even = sta1h + sta2h;
      sta_odd = sta1v + sta3v;
    }
    if (sta1hTri==1 && sta2hTri==1 && sta1vTri==1 && sta2vTri==0 && sta3vTri==0 && sta4vTri==1){
      sta_even = sta1h + sta2h;
      sta_odd = sta1v + sta4v;
    }
    if (sta1hTri==1 && sta2hTri==1 && sta1vTri==0 && sta2vTri==1 && sta3vTri==1 && sta4vTri==0){
      sta_even = sta1h + sta2h;
      sta_odd = sta2v + sta3v;
    }
    if (sta1hTri==1 && sta2hTri==1 && sta1vTri==0 && sta2vTri==1 && sta3vTri==0 && sta4vTri==1){
      sta_even = sta1h + sta2h;
      sta_odd = sta2v + sta4v;
    }
    if (sta1hTri==1 && sta2hTri==1 && sta1vTri==0 && sta2vTri==0 && sta3vTri==1 && sta4vTri==1){
      sta_even = sta1h + sta2h;
      sta_odd = sta3v + sta4v;
    }
    if (sta1hTri==1 && sta2hTri==1 && sta1vTri==1 && sta2vTri==1 && sta3vTri==1 && sta4vTri==0){
      sta_even = sta1h + sta2h;
      sta_odd = sta1v + sta2v + sta3v;
    }
    if (sta1hTri==1 && sta2hTri==1 && sta1vTri==1 && sta2vTri==1 && sta3vTri==0 && sta4vTri==1){
      sta_even = sta1h + sta2h;
      sta_odd = sta1v + sta2v + sta4v;
    }
    if (sta1hTri==1 && sta2hTri==1 && sta1vTri==1 && sta2vTri==0 && sta3vTri==1 && sta4vTri==1){
      sta_even = sta1h + sta2h;
      sta_odd = sta1v + sta3v + sta4v;
    }
    if (sta1hTri==1 && sta2hTri==1 && sta1vTri==0 && sta2vTri==1 && sta3vTri==1 && sta4vTri==1){
      sta_even = sta1h + sta2h;
      sta_odd = sta2v + sta3v + sta4v;
    }
    if (sta1hTri==1 && sta2hTri==1 && sta1vTri==1 && sta2vTri==1 && sta3vTri==1 && sta4vTri==1){
      sta_even = sta1h + sta2h;
      sta_odd = sta1v + sta2v + sta3v + sta4v;
    }
    if (!( sta_odd + sta_even == 0.)) {
